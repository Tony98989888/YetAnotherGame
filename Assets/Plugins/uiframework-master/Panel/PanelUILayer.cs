...
namespace deVoid.UIFramework
{
    ...
    public class PanelUILayer : AUILayer<IPanelController>
    {
        ...
        public bool IsPanelVisible(string panelId)
        {
            ...
            if (registeredScreens.TryGetValue(panelId, out panel)) return panel.IsVisible;
        ...
        {
            Transform trans;
            if (!priorityLayers.ParaLayerLookup.TryGetValue(priority, out trans)) trans = transform;
