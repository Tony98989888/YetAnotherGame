    ...
    public class UISettings : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            for (var i = 0; i < screensToRegister.Count; i++)
            {
                ...
                if (screenCtl == null) objectsToRemove.Add(screensToRegister[i]);
            }
            ...
            if (instanceAndRegisterScreens)
                foreach (var screen in screensToRegister)
                {
                    ...
                    if (screenController != null)
                    {
                        ...
                        if (deactivateScreenGOs && screenInstance.activeSelf) screenInstance.SetActive(false);
                    }
                    else
                    {
