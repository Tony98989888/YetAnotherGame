...
namespace deVoid.UIFramework
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        {
            if (windowLayer.CurrentWindow != null) CloseWindow(windowLayer.CurrentWindow.ScreenId);
        }
        ...
        public void ShowScreen(string screenId)
        {
            ...
            if (IsScreenRegistered(screenId, out type))
            {
                if (type == typeof(IWindowController))
                    OpenWindow(screenId);
                else if (type == typeof(IPanelController)) ShowPanel(screenId);
            }
            else
            {
        ...
        public void RegisterScreen(string screenId, IUIScreenController controller, Transform screenTransform)
        {
            ...
            if (window != null)
            {
                ...
                if (screenTransform != null) windowLayer.ReparentScreen(controller, screenTransform);
            ...
            if (panel != null)
            {
                ...
                if (screenTransform != null) panelLayer.ReparentScreen(controller, screenTransform);
            }
        }
